	...
	private void initListener() {
		addKeyListener(new KeyListener() {
			...
			public void keyReleased(KeyEvent e) { // 누른걸 떼면
				...
				if (e.getKeyCode() == KeyEvent.VK_RIGHT) { //안에 들어가서 살펴보면 final으로 구현이 되어 있다는걸 확인할 수 있다.
					// isRight를 false
			...
			//이클립스에서 get set 함수 이름이 무조껀 get set 이 아닌걸 기억하자!
			//source 에서 get set 을 설정할 수 있으니까 , 넣을때 따로 메소드 이름을 바꿀거면 미리미리 하자!
